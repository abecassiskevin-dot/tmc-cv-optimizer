...
if st.session_state.matching_done and st.session_state.matching_data:
    ...
    ">
        <div style="display: flex; align-items: start;">
            ...
            <div>
                <div style="font-weight: 700; color: #1e40af; font-size: 1.1rem; margin-bottom: 8px;">Matching Analysis Complete</div>
                <div style="color: #1e3a8a; line-height: 1.6;">
                    Score calculated and stored. Click <strong>"Generate TMC CV"</strong> to create the optimized resume with detailed analysis.
                </div>
            </div>
        </div>
    </div>
